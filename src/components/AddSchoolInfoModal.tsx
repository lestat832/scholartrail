...
interface AddSchoolInfoModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const AddSchoolInfoModal: React.FC<AddSchoolInfoModalProps> = ({ 
  isOpen, 
  onClose, 
  onContinue,
  onPrevious,
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6 sm:p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500">
              Share your field of study and expected graduation to find scholarships tailored to your academic path.
            </p>
          </div>
