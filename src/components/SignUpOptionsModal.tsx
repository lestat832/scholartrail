        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6 sm:p-8">
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              ...
              className="w-full font-medium py-3 px-4 rounded-md transition-all flex items-center justify-center space-x-2 bg-black text-white hover:bg-gray-900"
            >
            ...
            <button
              ...
              className="w-full font-medium py-3 px-4 rounded-md border transition-all flex items-center justify-center space-x-2 bg-white text-gray-700 border-gray-300 hover:bg-gray-50"
            >
